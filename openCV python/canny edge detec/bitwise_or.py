# cv2.bitwise_or(): performs a bitwise OR operation between two images or an image and a mask.
# This function is used to combine two images or to apply a mask to an image.
# The syntax for cv2.bitwise_or() is as follows:
...
bitwise_or_result = cv2.bitwise_or(image1, image2) # perform bitwise OR operation between the two images
...
cv2.imshow("Bitwise OR Result", bitwise_or_result) # display the result of the bitwise OR operation
